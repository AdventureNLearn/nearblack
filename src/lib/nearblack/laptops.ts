...
/** 25 stock laptops. Specs are typical SKUs, not a wattmeter. */
export const LAPTOPS: Laptop[] = [
  igpu("hp-pavilion-iris-xe", "HP Pavilion 15 · Iris Xe i7", 28, false, "The baseline. Shared iGPU. HUD must stay sparse."),
...
export const DEFAULT_LAPTOP_ID = "hp-pavilion-iris-xe";
